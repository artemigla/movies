...
export const DetailShow = ({ poster_path, first_air_date, last_air_date, vote_average, name, origin_country, overview }) => {
    ...
    return (
        <div className={style.wrapper}>
            <div className={style.wrapperimg}>
                <img className={style.img ? style.img : null} src={`${BASE_URL_IMAGES}${poster_path}`} alt={name} />
